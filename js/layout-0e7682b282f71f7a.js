    ...
    905: function (e, t) {
      ...
      function l(e) {
        ...
        for (let e in n) {
          ...
          "script" === t && ("async" === i || "defer" === i || "noModule" === i)
            ? (l[i] = !!n[e])
            : l.setAttribute(i, n[e]);
        }
        let { children: i, dangerouslySetInnerHTML: o } = n;
        return (
          o
      ...
      (n = (e, t) => {
        ...
        a.forEach((e) => {
          ...
          (r.content = (o - a.length + s.length).toString());
      }),
      ...
      function _(e) {
        ...
        if (
          ...
          ("beforeInteractive" === s || "worker" === s) &&
            (b
              ? ((m[s] = (m[s] || []).concat([
                  { id: t, src: n, onLoad: r, onReady: l, onError: d, ...y },
                ])),
                b(m))
              : _ && _()
              ? f.add(t || n)
