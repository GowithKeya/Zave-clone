    ...
    4307: function (i, e, o) {
      ...
      var r = (function () {
          ...
          return function (e, o, r) {
            return o && i(e.prototype, o), r && i(e, r), e;
          };
        })(),
        a = o(2265),
        n = t(a);
      ...
      var s = new (t(o(6088)).default)().getResult(),
        b = s.os.name,
        w = s.os.version,
        l = s.browser.name,
        c = s.browser.version,
      ...
      (k.OS = b),
        ...
        (k.CPU = h),
        (k.UA = v),
        (k.defaultProps = { rules: {}, className: "", style: {} }),
        (k.select = function (i) {
          return Object.keys(i).find(function (i) {
            return i === (void 0).OS;
          });
        }),
        (e.Z = k);
    ...
    6088: function (i, e, o) {
      ...
      !(function (a, n) {
        ...
        var t = "function",
          ...
          X = function (i, e) {
            for (var o, r, a, s, w, l, c = 0; c < e.length && !w; ) {
              var d = e[c],
                u = e[c + 1];
              for (o = r = 0; o < d.length && !w && d[o]; )
                if ((w = d[o++].exec(i)))
                  for (a = 0; a < u.length; a++)
                    (l = w[++r]),
                      typeof (s = u[a]) === b && s.length > 0
                        ? 2 === s.length
                          ? typeof s[1] == t
          ...
          J = function (i, e) {
            ...
            return (
              ...
              (this.getEngine = function () {
                var i = {};
                return (i[d] = n), (i[m] = n), X.call(i, r, k.engine), i;
              }),
              (this.getOS = function () {
                var i = {};
                return (
              ...
              (this.setUA = function (i) {
                return (
                  (r = typeof i === w && i.length > 500 ? W(i, 500) : i), this
                );
              }),
              this.setUA(r),
              this
        ...
        (J.VERSION = "0.7.39"),
          ...
          typeof e !== s
            ...
            ? n !==
                (r = function () {
                  return J;
                }.call(e, o, e, i)) && (i.exports = r)
            : typeof a !== s && (a.UAParser = J);
